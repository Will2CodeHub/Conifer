...
<head>
    ...
    <style>
        * {
        ...
        /* Template Cards - Professional 2025 Design */
        .template-card {
            background: white;
            border: 2px solid #e5e7eb;
            border-radius: 12px;
...
<body>
            ...
            <div id="social-media-tab" class="tab-content active">
                <div class="canvas-layout">
                    <div class="canvas-main">
                        <div class="canvas-toolbar" style="padding: 12px 16px; display: flex; flex-direction: column; gap: 12px;">
                            <!-- Row 1: Content Elements -->
                            <div style="display: flex; gap: 8px; align-items: center; padding-bottom: 12px; border-bottom: 1px solid #e5e7eb; flex-wrap: wrap; min-width: 0;">
                                <span style="font-size: 12px; font-weight: 600; color: #6b7280; text-transform: uppercase; min-width: 80px;">Elements</span>
                                <div class="toolbar-group" style="border: none; padding: 0;">
                            ...
                            <!-- Row 2: Arrangement & Style -->
                            <div style="display: flex; gap: 8px; align-items: center; padding-bottom: 12px; border-bottom: 1px solid #e5e7eb; flex-wrap: wrap; min-width: 0;">
                                <span style="font-size: 12px; font-weight: 600; color: #6b7280; text-transform: uppercase; min-width: 80px;">Arrange</span>
                                <div class="toolbar-group" style="border: none; padding: 0;">
                                ...
                                <div style="width: 1px; height: 24px; background: #d1d5db; margin: 0 8px;"></div>
                                <div class="toolbar-group" style="border: none; padding: 0;">
                                    <label style="font-size: 13px; color: #6b7280; margin-right: 8px;">Format:</label>
                                    <select id="formatSelector" onchange="changeCanvasFormat(this.value)" class="form-select" style="padding: 6px 12px; border: 1px solid #d1d5db; border-radius: 6px; font-size: 14px;">
                            ...
                            <div style="display: flex; gap: 8px; align-items: center;">
                                <span style="font-size: 12px; font-weight: 600; color: #6b7280; text-transform: uppercase; min-width: 80px; flex-wrap: wrap; min-width: 0;">Project</span>
                                <div class="toolbar-group" style="border: none; padding: 0;">
                                ...
                                <div class="toolbar-group" style="border: none; padding: 0;">
                                    ...
                                    <button class="toolbar-btn" onclick="openPreviewModal()">
                                        <i class="fas fa-eye"></i> Preview
                                    </button>
                                </div>
                                <div style="width: 1px; height: 24px; background: #d1d5db; margin: 0 8px;"></div>
                                <div class="toolbar-group" style="border: none; padding: 0;">
                                    <button class="toolbar-btn btn-primary" onclick="openExportModal()" style="background: #667eea; color: white; border-color: #667eea; font-weight: 600;">
    ...
    <div id="templateModal" class="modal">
        <div class="modal-content" style="max-width: 1200px; max-height: 90vh;">
            <div class="modal-header" style="background: #ffffff; color: #111827; padding: 24px 32px; border-bottom: 2px solid #e5e7eb;">
                <h2 style="color: #111827; margin: 0; font-size: 24px; font-weight: 600;"><i class="fas fa-layer-group" style="margin-right: 12px; color: #667eea;"></i><?php echo t('marketing.templates.title', 'Template Gallery'); ?></h2>
                <button class="modal-close" onclick="closeModal('templateModal')" style="color: #6b7280;">&times;</button>
            </div>
            <div class="modal-body" style="padding: 32px;">
                <div class="form-group" style="margin-bottom: 24px;">
                    <div style="display: flex; gap: 12px; margin-bottom: 24px; flex-wrap: wrap;">
                        <button class="btn template-tab-btn" id="myTemplatesBtn" onclick="loadUserTemplates()" style="flex: 1; min-width: 180px; padding: 12px 20px; background: #667eea; border: 2px solid #667eea; color: white; font-weight: 600; border-radius: 8px; transition: all 0.2s; cursor: pointer;">
                            <i class="fas fa-user" style="margin-right: 8px;"></i> My Templates
                        </button>
                        <button class="btn template-tab-btn" id="sharedTemplatesBtn" onclick="loadSharedTemplates()" style="flex: 1; min-width: 180px; padding: 12px 20px; background: white; border: 2px solid #d1d5db; color: #6b7280; font-weight: 600; border-radius: 8px; transition: all 0.2s; cursor: pointer;">
                            <i class="fas fa-users" style="margin-right: 8px;"></i> Shared Templates
                        </button>
                        <button class="btn template-tab-btn" id="defaultTemplatesBtn" onclick="loadDefaultTemplates()" style="flex: 1; min-width: 180px; padding: 12px 20px; background: white; border: 2px solid #d1d5db; color: #6b7280; font-weight: 600; border-radius: 8px; transition: all 0.2s; cursor: pointer;">
                            <i class="fas fa-star" style="margin-right: 8px;"></i> Default Templates
                        </button>
                    </div>
                </div>
                <div id="templateGallery" class="template-gallery" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 24px; max-height: 500px; overflow-y: auto; padding: 8px;">
            ...
            <div class="modal-footer" style="padding: 20px 32px; background: #f9fafb; border-top: 2px solid #e5e7eb; display: flex; gap: 12px; justify-content: flex-end;">
                <button class="btn btn-secondary" onclick="closeModal('templateModal')" style="padding: 12px 24px; font-size: 15px; font-weight: 600;">
                    <i class="fas fa-times" style="margin-right: 8px;"></i><?php echo t('common.cancel', 'Cancel'); ?>
                </button>
                <button class="btn btn-primary" onclick="applySelectedTemplate()" style="padding: 12px 24px; font-size: 15px; font-weight: 600; background: #667eea; color: white; border: none; border-radius: 8px;">
                    <i class="fas fa-check" style="margin-right: 8px;"></i> <?php echo t('common.apply', 'Apply Template'); ?>
                </button>
            </div>
        </div>
    </div>
                ...
                <div class="form-group" style="margin-bottom: 32px;">
                    ...
                    <div class="checkbox-group" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 16px;">
                        <div class="checkbox-item" style="display: flex; align-items: center; padding: 16px; border: 2px solid #e5e7eb; border-radius: 8px; cursor: pointer; transition: all 0.2s;" 
                             onclick="event.stopPropagation(); var cb = this.querySelector('input'); cb.checked = !cb.checked; updateExportPreview();">
                            <input type="checkbox" id="exportInstagram" value="instagram" style="width: 20px; height: 20px; margin-right: 12px; cursor: pointer; pointer-events: none;" onchange="updateExportPreview()">
                            <label for="exportInstagram" style="font-size: 15px; font-weight: 500; cursor: pointer; display: flex; align-items: center; gap: 8px; pointer-events: none;">
                                <i class="fab fa-instagram" style="font-size: 24px; color: #E4405F;"></i> Instagram
                            </label>
                        </div>
                        <div class="checkbox-item" style="display: flex; align-items: center; padding: 16px; border: 2px solid #e5e7eb; border-radius: 8px; cursor: pointer; transition: all 0.2s;"
                             onclick="event.stopPropagation(); var cb = this.querySelector('input'); cb.checked = !cb.checked; updateExportPreview();">
                            <input type="checkbox" id="exportFacebook" value="facebook" style="width: 20px; height: 20px; margin-right: 12px; cursor: pointer; pointer-events: none;" onchange="updateExportPreview()">
                            <label for="exportFacebook" style="font-size: 15px; font-weight: 500; cursor: pointer; display: flex; align-items: center; gap: 8px; pointer-events: none;">
                                <i class="fab fa-facebook" style="font-size: 24px; color: #1877F2;"></i> Facebook
                            </label>
                        </div>
                        <div class="checkbox-item" style="display: flex; align-items: center; padding: 16px; border: 2px solid #e5e7eb; border-radius: 8px; cursor: pointer; transition: all 0.2s;"
                             onclick="event.stopPropagation(); var cb = this.querySelector('input'); cb.checked = !cb.checked; updateExportPreview();">
                            <input type="checkbox" id="exportTwitter" value="twitter" style="width: 20px; height: 20px; margin-right: 12px; cursor: pointer; pointer-events: none;" onchange="updateExportPreview()">
                            <label for="exportTwitter" style="font-size: 15px; font-weight: 500; cursor: pointer; display: flex; align-items: center; gap: 8px; pointer-events: none;">
    ...
    <div id="previewModal" class="modal">
        <div class="modal-content" style="max-width: 90vw; max-height: 90vh;">
            <div class="modal-header">
                <h2><i class="fas fa-eye"></i> Canvas Preview</h2>
                <button class="modal-close" onclick="closeModal('previewModal')">&times;</button>
            </div>
            <div class="modal-body" style="display: flex; justify-content: center; align-items: center; padding: 40px; background: #f3f4f6;">
                <div id="previewContainer" style="box-shadow: 0 10px 40px rgba(0,0,0,0.2); background: white;"></div>
            </div>
        </div>
    </div>
