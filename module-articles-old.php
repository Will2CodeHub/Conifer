...
<div id="articleEditModal" aria-hidden="true" style="display:none;position:fixed;z-index:2000;left:0;top:0;width:100%;height:100%;overflow:auto;background:rgba(0,0,0,0.6);backdrop-filter:blur(8px);">
    <div id="articleEditModalDialog" role="dialog" aria-modal="true"
     style="width:95%;max-width:1600px;margin:30px auto;background:#fff;border-radius:12px;border:1px solid #e5e7eb;overflow:hidden;display:flex;flex-direction:column;max-height:92vh;box-shadow:0 20px 25px -5px rgba(0,0,0,0.1), 0 10px 10px -5px rgba(0,0,0,0.04);">
        
        <div style="display:flex;align-items:center;justify-content:space-between;padding:20px 28px;border-bottom:1px solid #e5e7eb;background:linear-gradient(to bottom, #ffffff, #fafbfc);">
            <div style="display:flex;align-items:center;gap:16px;">
                <div style="font-size:20px;font-weight:700;color:#111827;letter-spacing:-0.02em;display:flex;align-items:center;gap:10px;">
                    <i class="fas fa-edit" style="color:#2563eb;font-size:22px;"></i>
                    <span>Edit Article</span>
                    <span id="modalArticleId" style="font-weight:500;color:#6b7280;font-size:16px;"></span>
                </div>
                <button id="modal_fullscreen_toggle" title="Toggle fullscreen"
                        style="border:1px solid #d1d5db;background:#fff;padding:8px 14px;border-radius:8px;cursor:pointer;font-size:14px;transition:all 0.15s;color:#6b7280;display:flex;align-items:center;">
                    <i class="fas fa-expand"></i>
                </button>
            </div>

            <div style="display:flex;gap:10px;align-items:center;">
                <span id="modal_save_status" style="font-size:13px;color:#6b7280;margin-right:10px;font-weight:500;"></span>
                <button id="closeArticleModal" style="background:#fff;border:1px solid #d1d5db;color:#374151;padding:10px 20px;border-radius:8px;cursor:pointer;transition:all 0.15s;font-weight:600;display:inline-flex;align-items:center;gap:8px;font-size:14px;">
                    <i class="fas fa-times"></i> Close
                </button>
                <button id="saveDraftBtn" style="background:#fff;border:1px solid #d1d5db;color:#374151;padding:10px 20px;border-radius:8px;cursor:pointer;transition:all 0.15s;font-weight:600;display:inline-flex;align-items:center;gap:8px;font-size:14px;">
                    <i class="fas fa-save"></i> Save Draft
                </button>
                <button id="submitReviewBtn" style="background:#f59e0b;border:none;color:#fff;padding:10px 20px;border-radius:8px;cursor:pointer;transition:all 0.15s;font-weight:600;display:inline-flex;align-items:center;gap:8px;font-size:14px;box-shadow:0 1px 2px 0 rgba(0,0,0,0.05);">
                    <i class="fas fa-paper-plane"></i> Submit for Review
                </button>
                <button id="publishBtn" style="background:#10b981;border:none;color:#fff;padding:10px 20px;border-radius:8px;cursor:pointer;transition:all 0.15s;font-weight:600;display:none;align-items:center;gap:8px;font-size:14px;box-shadow:0 1px 2px 0 rgba(0,0,0,0.05);">
        ...
        <div style="display:flex;flex:1;overflow:hidden; flex-direction: column; @media (min-width: 768px) { flex-direction: row; }">
            <form id="ten_edit_article" method="post" onsubmit="return false;" novalidate="novalidate" style="display:contents;">
                ...
                <div style="flex:1 1 68%;padding:32px;box-sizing:border-box;border-right:1px solid #e0e0e0;display:flex;flex-direction:column;gap:24px;overflow-y:auto;background:#fafafa;">
                    
                    <div style="display:flex;align-items:flex-end;gap:16px;">
                        <div style="flex-grow:1;">
                            <label style="display:block;font-weight:600;margin-bottom:4px;color:#495057;" for="modal_title">Title</label>
                            <input type="text" id="modal_title" name="modal_title" placeholder="Article Title"
                                   style="width:100%;padding:12px;border:1px solid #ced4da;border-radius:4px;font-weight:700;font-size:1.3em;box-sizing:border-box;transition:border-color 0.2s;">
                        </div>
                    </div>
                    ...
                    <div style="display:flex;gap:20px;flex-wrap:wrap;border-top:1px solid #e9ecef;padding-top:20px;">
                        ...
                        <div style="flex:1 1 45%; min-width: 300px; display:flex; flex-direction:column; gap:20px;">
                            ...
                            <div>
                                <label style="display:block;font-weight:600;margin-bottom:4px;color:#495057;" for="modal_author">Author</label>
                                <select id="modal_author" name="modal_author" size="1"
                                        style="width:100%;padding:10px 12px;border:1px solid #ced4da;border-radius:4px;height:44px;box-sizing:border-box;background-color:#fff;">
                                    <option value="">Please select article author</option>
                                </select>
                            </div>
                            <div>
                                <label style="display:block;font-weight:600;margin-bottom:4px;color:#495057;" for="modal_alias">Alias (URL Slug)</label>
                                <input type="text" id="modal_alias" name="modal_alias" placeholder="e.g., my-article-title" 
                                       style="width:100%;padding:10px 12px;border:1px solid #ced4da;border-radius:4px;box-sizing:border-box;">
                            </div>
                            
                            <div>
                                <label style="display:block;font-weight:600;margin-bottom:4px;color:#495057;">Tags (comma separated)</label>
                                <input id="modal_tags" type="text" style="width:100%;padding:10px 12px;border:1px solid #ced4da;border-radius:4px;box-sizing:border-box;" />
                            </div>
                        ...
                        <div style="flex:1 1 45%; min-width: 300px; display:flex; flex-direction:column; gap:20px;">
                            ...
                            <div style="display:flex;gap:16px;">
                                <div style="flex:1;">
                                    <label style="display:block;font-weight:600;margin-bottom:4px;color:#495057;" for="modal_section">Section</label>
                                    <select id="modal_section" name="modal_section" size="1"
                                            style="width:100%;padding:10px 12px;border:1px solid #ced4da;border-radius:4px;height:44px;box-sizing:border-box;background-color:#fff;">
                                        <option value="">Choose section</option></select>
                                </div>
                                <div style="flex:1;">
                                    <label style="display:block;font-weight:600;margin-bottom:4px;color:#495057;" for="modal_section_subcat">Sub-category</label>
                            ...
                            <div>
                                <label style="font-weight:600;display:block;margin-bottom:8px;color:#495057;">Publication Assignments & Canonical</label>
                                <div id="modal_publications_container" style="max-height:200px;overflow-y:auto;border:1px solid #ced4da;padding:12px;border-radius:4px;background:#fff;display:flex;flex-direction:column;gap:10px;">
                                    <!-- Publications will be populated here as rows -->
                                </div>
                            </div>
                ...
                <div style="width:100%;flex:1 1 32%;min-width:340px;padding:32px;box-sizing:border-box;display:flex;flex-direction:column;gap:22px;background:#fff;overflow-y:auto;">
                    
                    <div style="border:1px solid #ddd;padding:18px;border-radius:4px;background:#fff;display:flex;flex-direction:column;gap:14px;">
                        <h4 style="font-size:1rem;font-weight:700;margin:0;padding-bottom:12px;border-bottom:1px solid #e0e0e0;color:#1f1f1f;">Options</h4>

                        <div style="display:flex;gap:20px;flex-wrap:wrap;padding-top:6px;">
                            <label style="display:flex;align-items:center;gap:8px;font-weight:600;color:#007bff;" for="modal_featured">
                                <input type="checkbox" id="modal_featured" name="modal_featured" value="1" style="transform:scale(1.1);" />
                                Featured
                            </label>
                    ...
                    <div style="border:1px solid #ddd;padding:18px;border-radius:4px;background:#fff;display:flex;flex-direction:column;gap:14px;">
                        <h4 style="font-size:1rem;font-weight:700;margin:0;padding-bottom:12px;border-bottom:1px solid #e0e0e0;color:#1f1f1f;">Publishing Schedule</h4>

                        <div>
                            <label style="display:flex;align-items:center;gap:8px;font-weight:600;color:#495057;">
                                <input id="modal_publish_now" type="checkbox" checked style="transform:scale(1.1);cursor:pointer;" />
                                Publish Now
                            </label>
                        </div>

                        <div id="publish_date_fields" style="display:none;">
                            <div style="display:flex;gap:16px;flex-wrap:wrap;">
                                <div style="flex:1;min-width:120px;">
                                    <label style="font-weight:600;display:block;margin-bottom:6px;color:#495057;font-size:0.95rem;">Publish From</label>
                                    <input id="modal_publish_from" type="text" placeholder="dd-mm-yyyy" style="width:100%;padding:10px 12px;border:1px solid #ced4da;border-radius:4px;box-sizing:border-box;font-size:14px;" />
                                </div>
                                <div style="flex:1;min-width:120px;">
                                    <label style="font-weight:600;display:block;margin-bottom:6px;color:#495057;font-size:0.95rem;">Publish To</label>
                                    <input id="modal_publish_to" type="text" placeholder="dd-mm-yyyy" style="width:100%;padding:10px 12px;border:1px solid #ced4da;border-radius:4px;box-sizing:border-box;font-size:14px;" />
                                </div>
                            </div>
                        </div>
                    </div>

                    <div id="modal_save_status" style="margin-top:6px;padding:8px;border-radius:4px;text-align:center;color:#666;background:#f5f5f5;font-size:13px;">Ready</div>
                </div>
            </form>
        </div>
        
        <div style="padding:10px 24px;border-top:1px solid #e0e0e0;text-align:right;background:#fafafa;">
            <span style="font-size:12px;color:#999;margin-right:8px;">Drag corner to resize</span>
    ...
    document.addEventListener('DOMContentLoaded', function () {
            ...
            rows.forEach(function (row) {
                ...
                const editBtn = row.editable == 1
                    ? '<button type="button" onclick="openEdit(' + row.id + ')" style="border:1px solid #0d6efd;background:#fff;color:#0d6efd;padding:6px 8px;border-radius:6px;cursor:pointer;">'
                        + '<i style="font-style:normal;">Edit </i></button>'
                    : '';
        ...
        function renderPagination(total, page, limitPerPage) {
            ...
            // First, Prev
            paginationUL.appendChild(createLi('Ã‚Â«', 1, page === 1, false));
            paginationUL.appendChild(createLi('Ã¢â‚¬Â¹', Math.max(1, page - 1), page === 1, false));
            ...
            // Next, Last
            paginationUL.appendChild(createLi('Ã¢â‚¬Âº', Math.min(totalPages, page + 1), page === totalPages, false));
            paginationUL.appendChild(createLi('Ã‚Â»', totalPages, page === totalPages, false));
        }
        ...
        function initSorting() {
            ...
            ths.forEach(function (th) {
                ...
                th.addEventListener('click', function () {
                    ...
                    if (span) span.textContent = (currentSortDir === 'ASC') ? 'Ã¢â€ â€˜' : 'Ã¢â€ â€œ';
    ...
    window.openEdit = function (id) {
        ...
        .then(json => {
            ...
            if (fld_evergreen) fld_evergreen.checked = (json.evergreen == 1 || json.evergreen == '1' || json.evergreen === true);
            if (fld_featured) fld_featured.checked = (json.featured == 1 || json.featured == '1' || json.featured === true);
            if (fld_sponsored) fld_sponsored.checked = (json.sponsored == 1 || json.sponsored == '1' || json.sponsored === true);
            if (fld_headline) fld_headline.checked = (json.headline == 1 || json.headline == '1' || json.headline === true || json.frontpage_temp == 1 || json.frontpage_temp == '1');
            ...
            // Toggle publish date fields visibility
            togglePublishDates();
            ...
            if (json.all_publications && json.all_publications.length > 0) {
                json.all_publications.forEach(function(pub) {
                    ...
                    row.style.cssText = 'display:flex;align-items:center;justify-content:space-between;padding:8px 10px;border-bottom:1px solid #f0f0f0;';
            ...
            if (movedEditor && originalEditor) {
                ...
                if (!inserted) {
                    ...
                    if (ta) {
                        ...
                        originalEditor.querySelector('#article_text[contenteditable="true"]') || document.querySelector('#modal_editor_slot .editor[contenteditable="true"]');
                        if (editorDiv) {
                            editorDiv.innerHTML = articleContent;
                            console.log('Editor content set, length:', articleContent.length);
                            inserted = true;
                        } else {
                            originalEditor.innerHTML = articleContent || originalEditor.innerHTML;
                            inserted = true;
                        }
                    }
                }
                ...
                if (clone) {
                    ...
                    if (ta) {
                        ...
                        if (editorDiv) {
                            ...
                            clone.innerHTML = articleContent || clone.innerHTML;
                        }
                    }
                }
            }
    ...
    // Toggle publish date fields based on publish_now checkbox
    function togglePublishDates() {
        const dateFieldsContainer = document.getElementById('publish_date_fields');
        if (dateFieldsContainer) {
            if (fld_publish_now.checked) {
    ...
    // Attach toggle handler to publish_now checkbox
    if (fld_publish_now) {
        fld_publish_now.addEventListener('change', togglePublishDates);
    }
    ...
    // Ensure modal can't be left with editor missing Ã¢â‚¬â€ on unload restore
