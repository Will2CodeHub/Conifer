...
try {
    ...
    // Insert admin user (TEN_Venues users table uses password_hash column)
    ...
    $insertSubQuery = "INSERT INTO company_subscriptions 
                      (company_id, pricing_package_id, subscription_status, start_date, 
                       next_billing_date, is_active, current_monthly_total_eur, package_id) 
                      VALUES (?, 1, ?, ?, ?, 1, 19.99, 1)";
